...
def view_points(
    ...
    if f_points is None:
        break_idx = [p for p in f_in.split("_") if p.isnumeric()][0]
        ...
        if "xyz" in data:
            ...
            sample_paths = [f for f in os.listdir(instance_dir) if "sampled" in f]
            for sp in sample_paths:
                cur_break_idx = [p for p in sp.split("_") if p.isnumeric()][0]
